...
class Vendor_renegotation1 extends CI_Controller {
	...
	public function index()
	{
		...
		$active1 = array('sellerid'=>$sess['sessi'],'poptions'=>true);
		...
		$this->load->view('vendor/renegotation1',$data);
		...
		header('location: '.base_url().'Vendor_renegotation1/index/'.urldecode($productid)."/".urldecode($buyerid));
