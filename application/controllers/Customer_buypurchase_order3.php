...
class Customer_buypurchase_order3 extends CI_Controller {
	...
	if($this->input->post('sellerid')){
		   ...
		   $query = $this->Admin_model->getdatafromtable('sellerpostproduct',$f); */
			...
			'priceperkg' => $priceperkg,'sellerprice'=>$sellerprice,'bsupplyability'=>$bsupplyability,'buyer_nego_price'=>$buyer_nego_price,'buyer_nego_units'=>$buyer_nego_units,'seller_renego_price'=> $seller_renego_price,'seller_renego_units'=>$seller_renego_units,'uploadporder'=>$pic_array1);
			//print_r($data);die;
