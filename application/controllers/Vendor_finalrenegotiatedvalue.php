...
class Vendor_finalrenegotiatedvalue extends CI_Controller {
	...
	public function index()
	{
		...
		$active1 = array('sellerid'=>$sess['sessi'],'custapprove'=>true);
	//print_r($active1); die;
		...
		$this->load->view('vendor/finalrenegotiatedvalue',$adac);
		...
		header('location: '.base_url().'Vendor_finalrenegotiatedvalue/index/'.urldecode($productid)."/".urldecode($busername));
