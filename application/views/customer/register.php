          ...
          <div class="col-lg-12">
            <div class="p-5">
			  ...
			  <h3 class="h5 text-gray-700 mb-2">Contact Info</h3> 	
				...
				<div class="col-sm-6 mb-3 mb-sm-0">
                  ...
                  <div class="col-sm-6">
				   ...
				   <div class="col-sm-6 mt-2">
                    <input type="text" class="form-control form-control-user" id="exampleCompanyName" placeholder="Company Name">
                  </div>
				   <div class="col-sm-6 mt-2">
                    <input type="text" class="form-control form-control-user" id="exampleContactNumber" placeholder="Contact Number">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
					<input type="text" class="form-control form-control-user" id="exampleSelectState" placeholder="Select State">
                  </div>
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" id="exampleInputPincode" placeholder="Pincode">
                  </div>
                </div>
                <a href="<?php echo base_url();?>customer_login" class="btn btn-primary btn-user btn-block">
                  Register Account
                </a>
                <!-- <hr>
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="<?php echo base_url();?>home_forgot-password">Forgot Password?</a>
              </div>
              <div class="text-center">
                <a class="small" href="<?php echo base_url();?>customer_login">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
