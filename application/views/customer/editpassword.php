				...
				<table class="table table-sm table-borderless">
					 <thead><th width="45%">Password</th>
						...
						<div class="error-msg"></div>
							<tr>
								<td>Old Password</td>
								<td><input class="form-control w-50" type="password" id="bpassword"  name="boldpassword"placeholder="******" ></td>
							</tr> 
							<tr>
								<td>New Password</td>
							...
							<tr>
								...
								<td><input class="form-control w-50" type="password" id="brepeatpassword" name="brepeatpassword" placeholder="******"></td>
							</tr> 	
