          ...
          <div class="col-lg-12">
            <div class="p-5">
			  ...
			  <h3 class="h5 text-gray-700 mb-2">Contact Info</h3> 	
                ...
                <a href="<?php echo base_url();?>vendor_login" class="btn btn-primary btn-user btn-block">
                  Register Account
                </a>
               <!--  <hr>
              ...
              <div class="text-center">
                <a class="small" href="<?php echo base_url();?>vendor_login">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
