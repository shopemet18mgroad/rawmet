  <div class="container-fluid">
	...
	<td style="color:orange"><b><?php  if($row->buyer_approval == 0) {echo 'Pending to Approve';}else if($row->buyer_approval == 2) {echo 'Rejected';}else if($row->buyer_approval == 1) {echo 'Approved';}?></b></td>
