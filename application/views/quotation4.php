...
<table  class="table-border" id="customers">
  ...
  <tr>
    ...
    <td><?php echo  $sqldata1[0]->description;?></td>
		...
		<td><?php echo $sqldata1[0]->brenegoquantity.""; echo $sqldata1[0]->units;?></td>
	<td><?php echo$sqldata1[0]->brenegoprice."/"; echo $sqldata1[0]->brenegounit;?></td>
    <td><?php echo $a = $sqldata1[0]->brenegoquantity*$sqldata1[0]->brenegoprice;?></td>
  </tr>
