...
<body>
    <div id="logreg-forms">
        <form class="form-signin" action="../weblib/login.php" method="POST">
            <h1 class="h3 mb-3 font-weight-normal" style="text-align: center"> <img class="img-fluid" alt="Aucjunction"  src="http://aucjunction.net/images/aucjunction.jpg"></h1>
            <p style="text-align:center"><b>Aucjunction Survey Form Login</b></p>
